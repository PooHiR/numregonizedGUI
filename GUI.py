...
class FirstUi(QMainWindow):  # 第一个窗口类
    ...
    def init_ui(self):
        ...
        # self.label_name = QLabel('AUTHOR: Ek0wraith', self)
        # self.label_name.setGeometry(460, 410, 200, 30)
        # self.label_name = QLabel('QQ: 478071496', self)
...
class write_num(QWidget):
    ...
    def __InitView(self):
        ...
        self.label_name.setGeometry(500, 105, 100, 30)

        self.edit = QTextEdit(self)
        self.edit.setGeometry(505, 140, 110, 60)
